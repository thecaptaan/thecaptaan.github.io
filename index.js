...
function portfolioScreen() {
  ...
  let data = [
    ...
    {
      img: "./assets/images/realpandit.png",
      title: "Real Pandit",
      sub: "Backend Development",
      link: "https://realpandit.com",
      description: "A platform to book pandits for various rituals.",
    },
    {
      img: "./assets/images/techdefenders.png",
      title: "Tech Defenders",
      sub: "Freelance",
      link: "https://techdefenders.in",
      description: "I worked as a freelancer for their company project.",
    },
    {
      img: "./assets/images/xorblin.png",
      title: "Xorblin",
      sub: "Web Development",
      link: "https://xorblin.com",
      description: "I started this company with my friends. We are providing IT Services & Consultancy.",
    },
    {
...
function blogScreen() {
  ...
  let data = [
    {
      img: "./assets/images/web-developer.jpg",
      title: "Express JS For Beginners",
      sub: "Web Development",
      link: "https://dev.to/thecaptaan/express-js-for-beginners-5cl8",
      description:
        "Explore the fundamentals of web development with Express.js in this beginner-friendly guide, covering the basics of routing, middleware, and building RESTful APIs using the popular Node.js framework",
    },
  ];
  let blogHtml = `
...
function contactScreen() {
  ...
  let contactHtml = `<div>
    ...
    <div class="contact-card-container row">
                <a class="aside-card row" href="mailto:thecaptaan@proton.me">
                    <div class="aside-icon-cont">
                        <svg id="aside-icon" height="200px" width="200px" version="1.1" id="_x32_"
                    ...
                    <div class="col">
                        <span class="aside-card-header">Email</span>
                        <span>thecaptaan@proton.me</span>
                    </div>
                </a>
                <a class="aside-card row" href="https://maps.app.goo.gl/1V21ToDGpbNAEdjn9">
                    <div class="aside-icon-cont">
                        <svg id="aside-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                    ...
                    <div class="col">
                        <span class="aside-card-header">Address</span>
                        <span>Bettiah, Bihar - Bharat</span>
                    </div>
                </a>
                <a class="aside-card row"
                    ...
                    <div class="aside-icon-cont">
                        <svg id="aside-icon" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="#ffdb70">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                    ...
                    <div class="col">
                        <span class="aside-card-header">Whatsapp</span>
